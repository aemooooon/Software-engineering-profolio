...
First of all, the first of Agile manifesto stated that Individuals and interactions over processes and tools, which means compared with tools and processes, people are the core factor. The value of people and people directly interacting with each other is higher than the value of tools and processes. I think the software development industry is different from the traditional factory manufacturing industry. They emphasize tools and processes because they generate fixd stuff, do not need people creativity, and no frequent changes in demand. The software development needs change rapidly, and if you don't keep up with the customer's needs in time, it will waste the developer's time and cost. Therefore, we can communicate with customers in a timely manner, and quickly display short-item displayable products to customers to create value efficiently. <u>In this respect, our team is doing very well. Each of our Sprints meets at least one or two times with our customer, reports our results, shows our progress, and our team members meet at least twice a week. And our job is basically to turn the customer's needs into user stories, and then directly execute, without writing data modeling documents, requirements documents, business logic, use case diagrams, etc.</u>

Secondly, the second on the Agile Manifesto says Working software over comprehensive documentation. At this point, we also do a good job. <u>After each of our Sprints, we have had met with our customer Paul and show him the work of our previous stage. 
Because it is our live online DEMO, so customers can see our results very intuitively, customers can directly see the gap, if there is any direction of error, directly pointed out to correct it. </u> Rather than writing a month's worth of documentation like my previous work, customers can't see anything, and most customers don't know the technology, so they don't make sense to read the documentation.

Thirdly, Customer collaboration over contract negotiation. <u>We did it. If you look at my goals, you will find that our cooperation with our customers is simply intimate. We show our work, he points out his needs and changes, gives me a new user story, so that iteratively, every time it will improve, while efficiency remains high.</u> Rather than traditional development methods, once the documentation is completed and the solution is determined, it is developed according to the established plan. If the customer needs to modify it later, it needs to be renegotiated. This operation will result in the final product being different from the customer's expectation. Software developers will charge more fees like customers, which is not conducive to dual-issue work, and can not improve the efficiency of product development.

Interms of the fourth of the Agile Manifesto, Responding to change over the following a plan. Fully applied to the approach of our team. <u>For example, our customer Paul wants us to implement Raw Numbers of stock in the second Sprint, and expresses the ability to implement borrowing in the third Sprint. In the fourth Sprint, He hope to have a short message Dashboard function and user access control, search for special items features.</u> These examples illustrate the constant changes in customer needs (based on the functionality we have already completed), and each of our Sprint's meetings provides a real-time response to customer changes.

About the <b>Scrum Master</b>. Throughout the semester, all the Sprints of our team did not stipulate who is the project owner, who is the Scrum Master, all things are decided together, we have assign a relatively fair task, no one has the absolute responsibility assigned to each A person. But I think if you go to work in the company, the company will pay you, so you will definitely take responsibility. So I made some conclusions. If I am a Scrum Master, how should I think about it and how to do it:
For example, at the beginning of every Sprint, I must first make an appointment with the customer and see the customer, and get the user story, then do some sorting and summarization, make a Backlog, and of course the current Sprint goal, and then divide these into average tasks. Then there is a meeting with all team members, each of whom expresses their views and then assigns the tasks. Since we have 2 class per week about software engineering, we should have a short meeting in each lesson. Just talk about what everyone has done in the past 3 days, and what will continue to do next? What obstacles are encountered during this period, and whether coordination is needed. Then you should record your report and draw the BrunDown Chart. Next, at the end of this Sprint, I should call our leaders (here are our lecurer Martin or Elise) to open a meeting with our customer Paul. The content of the meeting is to show our customers and leaders the results of our Sprint work. And summarize what is done well, what needs to be improved, and avoid encountering similar problems in the next Sprint.
...
<b>However</b>, we have had a bad side of doing it, such as in the Kanban method. We didn't use the lane function of Kanban. We just took the whole Sprint as a lane, so it is ok for us now. We also don't use WIP (Limit Work In Progress). If the bottle neck of a kanban is 5, we should concentrate on the five user stories, and then complete the next batch of user stories, which is more efficient than working more user stories at the same time. This is like a traffic jam on the road. If a person is blocked, it is possible for a car to stop and everyone is waiting to waste time and reduce efficiency. The efficient team should be a continuous stream of stability, stable delivery, and always give customers some feedback to deliver the highest possible value. In addition, the function of Kanban is to provide an intuitive way to observe the progress, and to avoid the bottleneck of the team. These are the places that our team needs to improve, and the extent to which the perfect kanban method has not been achieved.
